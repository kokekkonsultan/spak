...
$route['survei/(:any)/form-opening/convert'] = 'SurveiController/convert_form_opening/$1';
...
$route['manage-survey/ajax-open-survey/(:num)'] = 'ManageSurveyController/ajax_open_survey/$1';
...
$route['(:any)/(:any)/laporan-survey/generate'] = 'LaporanSurveyController/generate/$1/$2';
$route['(:any)/laporan-survey/download-pdf/(:any)'] = 'LaporanSurveyController/download_pdf/$1/$2';
$route['(:any)/laporan-survey/download-word/(:any)'] = 'LaporanSurveyController/download_word/$1/$2';
...
$route['(:any)/(:any)/analisa-survei/edit-alasan/(:any)'] =  'AnalisaSurveiController/edit_alasan/$1/$2/$3';
...
$route['(:any)/(:any)/layanan-survei/pilihan-jenis'] = 'LayananSurveiController/pilihan_jenis/$1/$2';

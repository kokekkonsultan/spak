...
class SurveiListController extends CI_Controller
{
    ...
    public function index()
    {
        ...
        $this->data['penayang_survei'] = $this->db->query("SELECT * FROM penayang_survei JOIN u1489187_auth.users u ON penayang_survei.id_user = u.id WHERE link_penayang = '$slug'")->row();

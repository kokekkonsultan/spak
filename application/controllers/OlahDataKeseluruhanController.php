...

{
...

    {
        ...
        // $this->data['induk'] = $this->db->get_where("u1489187_auth.pengguna_admin_induk", array('id_user' => $this->session->userdata('user_id')))->row();
        $id_user = $this->session->userdata('user_id');
        // $this->data['induk'] = $this->db->get_where("u1489187_auth.pengguna_admin_induk", array('id_user' => $id_user))->row();
...

    {
            ...
            $this->db->select('*, manage_survey.slug AS slug_manage_survey, (SELECT first_name FROM u1489187_auth.users WHERE id = manage_survey.id_user) AS first_name, (SELECT last_name FROM u1489187_auth.users WHERE id = manage_survey.id_user) AS last_name');

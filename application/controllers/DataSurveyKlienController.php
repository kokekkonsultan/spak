...
class DataSurveyKlienController extends CI_Controller
{
	...
	public function get_detail_survey($id = NULL)
	{
		...
		$this->db->join('u1489187_auth.users u', 'u.id = manage_survey.id_user');
		$this->db->join('u1489187_auth.klasifikasi_survei ks', 'ks.id = u.id_klasifikasi_survei', 'left');
	...
	public function form_survei()
	{
		...
		$this->data['data_user'] = $this->db->get_where('u1489187_auth.users', array('id' => $this->data['manage_survey']->id_user))->row();

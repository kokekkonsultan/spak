    ...
    <div class="row mt-5">
        ...
        <div class="col-md-9">
            ...
            <div class="card card-body" data-aos="fade-down">
                <h4 class="text-center text-primary"><b>Nilai IPAK : {{ROUND($nilai_tertimbang, 3)}}
                        ...
                        <tbody>
                            ...
                            foreach ($nilai_per_unsur->result() as $value) { ?>
                                <tr>
                                    ...
                                    <td>
                                        <a href="{{ base_url() }}{{ $ci->session->userdata('username'); }}/{{ $ci->uri->segment(2) }}/analisa-survei/detail-unsur/{{ $value->id_sub }}" class="btn btn-light-primary btn-sm font-weight-bold"><i class="fa fa-book"></i>
                                            Lakukan Analisa</a>
                                    </td>
                                </tr>
                            <?php } ?>
                        ...
                        <tbody>
                            ...
                            foreach ($nilai_per_sub_unsur->result() as $value) { ?>
                                <tr>
                                    ...
                                    <td>
                                        <a href="{{ base_url() }}{{ $ci->session->userdata('username'); }}/{{ $ci->uri->segment(2) }}/analisa-survei/detail-unsur/{{ $value->id_unsur_pelayanan }}" class="btn btn-light-primary btn-sm font-weight-bold"><i class="fa fa-book"></i>
                                            Lakukan Analisa</a>
                                    </td>
                                </tr>
                            <?php } ?>

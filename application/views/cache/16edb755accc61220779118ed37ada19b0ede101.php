            ...
            <div class="modal-body">
                ...
                <form id="form-filter" class="">
                    ...
                    <div class="form-group row">
                        ...
                        <!-- <div class="col-md-6 mb-5">
                            <label class="form-label font-weight-bold text-primary">Jenis Pelayanan</label>
                            <select id="id_layanan_survei" class="form-control">
                                <option value="">Please Select</option>
                                ...
                                <option value="<?php echo e($row->id); ?>"><?php echo e($row->nama_layanan); ?></option>
    ...
    table = $('#table').DataTable({
        ...
        "ajax": {
            ...
            "data": function(data) {
                ...
                data.id_layanan_survei = $('#id_layanan_survei').val();
...
<?php $__env->stopSection(); ?>
<?php echo $__env->make('include_backend/template_backend', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\Users\IT\Documents\Htdocs MAMP\surveiku_spak\application\views/data_perolehan_survei/index.blade.php ENDPATH**/ ?>
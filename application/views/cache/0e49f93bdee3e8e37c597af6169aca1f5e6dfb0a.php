...
<div class="table-responsive mt-10">
    <table width="100%" class="table table-bordered" id='myolahdata' style="font-size: 12px;">
        ...
        <tr>
            ...
            <?php $__currentLoopData = $koreksi_total->result(); $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $total): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
            <td>
                <div align="center">
        ...
        <tr>
            ...
            <?php $__currentLoopData = $koreksi_rata_rata->result(); $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $rata_rata): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
            <td>
        ...
        <tr>
            ...
            <?php $__currentLoopData = $koreksi_nilai_per_unsur->result(); $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $nilai_per_unsur): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
        ...
        <tr>
            ...
            <td colspan="<?php echo e($jumlah_pertanyaan); ?>">
                <div><strong><?php echo e($koreksi_mutu); ?></strong></div>
            </td>
        </tr>
        ...
        <tr>
            ...
            <td colspan="<?php echo e($jumlah_pertanyaan); ?>">
                <div><strong><?php echo e($koreksi_kategori); ?></strong></div>
            </td>
        </tr>
    </table>
</div><?php /**PATH C:\Users\IT\Documents\Htdocs MAMP\surveiku_spak\application\views/koreksi_data/data_koreksi.blade.php ENDPATH**/ ?>
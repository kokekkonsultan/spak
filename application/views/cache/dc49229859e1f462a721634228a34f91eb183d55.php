...
<head>
	...
	<link rel="icon" type="image/png" href="<?php echo e(base_url()); ?>assets/img/site/logo/favicon.png">
    <style>
    .ajax-loader {
...
// 	$cek_data_langganan = $ci->db->query("SELECT tanggal_mulai, tanggal_selesai FROM u1489187_auth.berlangganan WHERE id_user = '$cek_user_now->id' AND id_produk = '2' ORDER BY id DESC")->row();
// }else{
// 	$cek_data_langganan = $ci->db->query("SELECT tanggal_mulai, tanggal_selesai FROM u1489187_auth.berlangganan WHERE id_user = '$cek_user_now->id_parent_induk' AND id_produk = '2' ORDER BY id DESC")->row();
// }
...
<body id="kt_body"
    ...
    <div id="kt_header_mobile" class="header-mobile align-items-center header-mobile-fixed">
        <a href="<?php echo e(base_url()); ?>dashboard">
            <img alt="Logo" src="<?php echo e(base_url()); ?>assets/img/site/logo/logo-dashboard.png" />
        </a>
...
</html><?php /**PATH C:\Users\IT\Documents\Htdocs MAMP\surveiku_spak\application\views/include_backend/template_backend.blade.php ENDPATH**/ ?>
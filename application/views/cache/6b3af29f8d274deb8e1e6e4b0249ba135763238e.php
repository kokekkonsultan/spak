...
<div class="modal fade" id="exampleModal" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel" aria-hidden="true">
    ...
    <script>
        FusionCharts.ready(function() {
            var myChart = new FusionCharts({
                ...
                dataSource: {
                    chart: {
                        caption: "Hasil Survei Persepsi Anti Korupsi Per Akun Anak",
    ...
    </script><?php /**PATH C:\Users\IT\Documents\Htdocs MAMP\surveiku_spak\application\views/dashboard/chart_survei_induk.blade.php ENDPATH**/ ?>
            ...
            <div class="card card-custom gutter-b">
                <div class="card-body">
                            ...
                            <div class="d-flex align-items-center flex-wrap justify-content-between">
                                <div class="d-flex flex-wrap align-items-center py-2">
                                    <div class="d-flex align-items-center">
                                        ...
                                        <div class="mr-6">
                                            <div class="font-weight-bold mb-2">Jenis Pelayanan</div>
                                            <span
                                        ...
                                        <div class="">
                                            ...
                                            <span
                                                class="btn btn-sm btn-text btn-light-primary text-uppercase font-weight-bold">
                                                <?php echo e($profiles->skala_likert == '' ? 4 : $profiles->skala_likert); ?> Pilihan
                                                Jawaban</span>
                                        </div>
                                    </div>
                                </div>
                    ...
                    <div class="d-flex align-items-center">
                        ...
                        <?php if($profiles->jumlah_sampling >= $jumlah_kuisioner){ ?>
                        <div class="d-flex align-items-center flex-lg-fill mr-5 my-1">
                            <span class="mr-4">
                                <i class="flaticon-file-2 icon-2x text-muted font-weight-bold"></i>
                            </span>
...
<div class="modal fade" id="survei_date" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel"
    ...
    <div class="modal-dialog" role="document">
        <div class="modal-content">
            <div class="modal-header bg-secondary">
                <h5 class="modal-title" id="exampleModalLabel">Periode Survei</h5>
                <button type="button" class="close" data-dismiss="modal" aria-label="Close">
                    <span aria-hidden="true">&times;</span>
                </button>
            </div>
            ...
            <div class="modal-content">
                ...
                <div class="modal-body">
                    ...
                    <form
                        ...
                        <div class="row mb-5">
                            <div class="col-sm-12">
                                ...
                                <div class="radio-list">
                                    <?php
                                    ($manage_survey->id_sampling == '0') ? $checked_sampling = 'checked' :
                                    $checked_sampling = '';
                                    ?>
                                    <label class="radio"><input type="radio" name="id_sampling" id="0" value="0"
                                            class="sampling" <?php echo e($checked_sampling); ?>><span></span>&nbsp Tanpa
                                        Sampling</label>
                                    <?php
                                    ($manage_survey->id_sampling == '1') ? $checked_sampling = 'checked' :
                                    $checked_sampling = '';
                                    ?>
                                    <label class="radio"><input type="radio" name="id_sampling" id="1" value="1"
                        ...
                        <div class="row" name="pilih_sampling" id="pilih_sampling" <?= $manage_survey->id_sampling == 0 ? 'style="display:none;"' : '' ?>>
...
<?php if($manage_survey->organisasi == '' || $manage_survey->jumlah_populasi == ''): ?>
<script type="text/javascript">
    // || $manage_survey->description == '' || $manage_survey->alamat == '' || $manage_survey->no_tlpn == '' || $manage_survey->email == '' || $manage_survey->misi == '' || $manage_survey->visi == ''
...
<?php $__env->stopSection(); ?>
<?php echo $__env->make('include_backend/template_backend', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\Users\IT\Documents\Htdocs MAMP\surveiku_spak\application\views/manage_survey/form_repository.blade.php ENDPATH**/ ?>
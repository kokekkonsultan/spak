...
<div class="text-center mt-5">
    <div class="symbol symbol-60 symbol-xxl-100 mr-5 align-self-start align-self-xxl-center" id="photo_profile">
        ...
        <img class="" src="{{URL_AUTH}}assets/klien/foto_profile/200px.jpg" alt="">
        @else
...
<div class="aside-menu-wrapper flex-column-fluid" id="kt_aside_menu_wrapper">
    ...
    <div id="kt_aside_menu" class="aside-menu my-4" data-menu-vertical="1" data-menu-scroll="1"
        ...
        <ul class="menu-nav">
            ...
            {{-- @php
            $group = array('client_induk');
            ($ci->uri->segment(1) == 'e-sertifikat') ? $child_menu_active = 'menu-item-active' :
            $child_menu_active = '';
            @endphp
            @if ($ci->ion_auth->in_group($group))
            <li class="menu-item {{ $child_menu_active }}" aria-haspopup="true">
            <a href="{{ base_url() }}e-sertifikat" class="menu-link">
                <span class="svg-icon menu-icon">
                    <svg xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink" width="24px"
                        height="24px" viewBox="0 0 24 24" version="1.1">
                        <g stroke="none" stroke-width="1" fill="none" fill-rule="evenodd">
            ...
            <li class="menu-item menu-item-submenu {{ $main_menu_active }}" aria-haspopup="true"
                ...
                <div class="menu-submenu">
                    ...
                    <ul class="menu-subnav">
                        ...
                        @endphp
                        <li class="menu-item {{ $child_menu_active }}" aria-haspopup="true">
                            <a href="{{ base_url() }}paket-berlangganan" class="menu-link">
                                <i class="menu-bullet menu-bullet-dot">
                                    <span></span>
                                </i>
                        ...
                        @endphp
                        <li class="menu-item {{ $child_menu_active }}" aria-haspopup="true">
                            <a href="{{ base_url() }}kuota-jumlah-responden" class="menu-link">
                                <i class="menu-bullet menu-bullet-dot">
                                    <span></span>
                                </i>

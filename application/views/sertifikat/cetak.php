...
<body>
        ...
        <table style="width: 100%; text-align:center; margin-top:55px; margin-left:5px;">
            <tr style="font-weight: bold;">
                <td>
                    ...
                    <img src="<?php echo URL_AUTH . 'assets/klien/foto_profile/200px.jpg' ?>" height="100" alt="" />
                    <?php else : ?>
                    <img src="<?php echo URL_AUTH . 'assets/klien/foto_profile/' . $user->foto_profile ?>"
                        height="100" alt="" />
                    <?php endif; ?>
                </td>
            </tr>
  ...
  margin-right: auto;">
            ...
            <tr style="font-size: 13px;">
                <th style="width:20%;">NILAI IPAK KONVERSI</th>
                <th style="width:2%;"></th>

        ...
        <div class="col-md-9">
                ...
                <div class="card-body d-flex align-items-center">
                    <div>
                        ...
                        <div class="alert alert-white font-weight-bold" role="alert">
                            Anda bisa menerbitkan sertifikat SPAK dengan melengkapi form dibawah ini. Sertifikat yang
            ...
            <div class="card" data-aos="fade-down">
                ...
                <div class="card-body">
                    ...
                    <form method="post"
                        action="{{base_url() . $ci->session->userdata('username') . '/' . $ci->uri->segment(2) . '/e-sertifikat'}}"
                        ...
                        <div class="form-group row">
                            ...
                            <div class="col-sm-9">
                                <select id="profil_responden" name="profil_responden[]" class="form-control"
                                    ...
                                    <option value="{{$row->id}}">{{$row->nama_profil_responden}}</option>
                                    @endforeach
                                </select>
                            </div>
                        </div>
                        ...
                        <div class="form-group row">
                            ...
                            <div class="col-9 col-form-label">
                                ...
                                <div class="mt-3" id="dengan_tanda_tangan" style="display: none;">
                                    ...
                                    @if($manage_survey->img_ttd_sertifikat == '')
                                    ...
                                    <div class="row">
                                        <div class="custom-file col-md-3">
                                            <img src="{{base_url() . 'assets/klien/ttd_sertifikat/' . $manage_survey->img_ttd_sertifikat}}"

...
<body>
        ...
        <!-- <div id="watermark">
            <img src="<?php echo URL_AUTH . 'assets/klien/foto_profile/' . $profiles->foto_profile ?>" height="100%" width="100%" />
        </div> -->
    ...
    <div class="page-session">
        <div style="text-align:center;">
            ...
            <?php } else { ?>
            <img src="<?php echo URL_AUTH . 'assets/klien/foto_profile/200px.jpg' ?>" alt="Logo" width="250" class="center">
            <?php } ?>
            ...
            <tr>
                <td style="width: 10%;">
                    ...
                    <img src="<?php echo URL_AUTH . 'assets/klien/foto_profile/' . $profiles->foto_profile ?>"
                        alt="Logo" width="70">
                    <?php } else { ?>
                    <img src="<?php echo URL_AUTH . 'assets/klien/foto_profile/200px.jpg' ?>" alt="Logo" width="70">
                    <?php } ?>
                </td>
                <td>
    ...
    <footer>
        <div style="text-align:center;">
            <hr>
            <div style="font-size: 13px;">SPAK <?php echo date("Y") ?> - Generate by <a target="_blank" href="https://surveiku.com/" style="color:black;">SurveiKu.com</a></div>
            <p class="page"></p>
        </div>
    </footer>
    ...
    <main>
            ...
            <table style="width: 100%;">
                ...
                <tr>
                    <td class="content-paragraph">
                        Praktik tata kelola pemerintahan yang baik (good governance) menjadi fokus pemerintah dalam
                        meningkatkan penyelenggaraan pelayanan kepada masyarakat. Salah satu upaya untuk mencapai
                        pemerintahan yang baik diantaranya dapat dilakukan dengan meminimimalkan terjadinya korupsi;
                        pandangan minoritas terwakili dan dipertimbangkan; serta pandangan dan pendapat kaum yang paling
                        lemah didengarkan dalam pengambilan keputusan. Sampai dengan saat ini, korupsi menjadi fenomena
                        yang masih melekat di instansi pemerintahan. Oleh karenanya, banyak upaya yang telah ditetapkan
                        oleh pemerintah untuk menekan korupsi di instansi pemerintahan. Hal ini dapat dilihat mulai dari
                        ditetapkannya Peraturan Presiden tentang strategi nasional pencegahan korupsi, pembangunan Zona
                        Integritas menuju wilayah bebas dari korupsi, sampai dengan diterbitkannnya SNI tentang Sistem
                        Manajemen Anti Penyuapan ISO 37001 oleh Badan Standarisasi Nasional (BSN).
                    </td>
                </tr>
                <tr>
                    <td class="content-paragraph">
                        Oleh karena pentingnya upaya pencegahan dan pemberantasan korupsi, maka setiap K/L/D diharuskan
                        mengambil langkah-langkah yang diperlukan sesuai tugas, fungsi dan kewenangan masing-masing
                        dalam rangka pencegahan dan pemberantasan korupsi di Indonesia. Langkah pencegahan dan
                        pemberantasan korupsi oleh instansi pemerintah dapat diterapkan melalui Persepsi Anti Korupsi
                        melalui Survei Persepsi Anti Korupsi (SPAK) yang akan menghasilkan index persepsi anti korupsi.
                        Index Persepsi Anti Korupsi merupakan hasil survei kuantitatif terhadap stakeholders yang
                        terkait dengan suatu instansi tentang tingkat korupsi yang terjadi pada instansi tersebut.
                    </td>
                </tr>
                <tr>
                    <td class="content-paragraph">
                        Mahkamah Konstitusi selaku lembaga tinggi negara juga wajib mendukung upaya pencegahan dan
                        pemberantasan korupsi. Untuk itu, pada tahun ini dilakukan pengukuran persepsi anti korupsi
                        melalui Survei Persepsi Anti Korupsi (SPAK) pada lingkungan Mahkamah Konstitusi. Selain untuk
                        mencegah dan memberantas korupsi, Survei Persepsi Anti Korupsi (SPAK) juga merupakan bagian dari
                        perwujudan Zona Integritas menuju wilayah bebas dari korupsi sebagaimana yang diamanatkan dalam
                        Peraturan Menteri Pendayagunaan Aparatur Negara dan Reformasi Birokrasi Nomor 90 Tahun 2021
                        tentang Pembangunan dan Evaluasi Zona Integritas Menuju Wilayah Bebas dari Korupsi dan Wilayah
                ...
                <tr>
                    <td style=" padding-left:1.5em;">Kegiatan Survei Persepsi Anti Korupsi (SPAK)
                        bertujuan untuk :
                        <ol>
                            <li>Mengukur nilai Indeks Persepsi Anti Korupsi (IPAK);</li>
                            <li>Sebagai bahan dalam pengambilan kebijakan untuk 
                                mencegah korupsi, kolusi dan nepotisme dalam rangka peningkatan kualitas pelayanan;</li>
                            <li>Mewujudkan pelaksanaan pelayanan yang bebas korupsi.</li>
                        </ol>
                    </td>
                </tr>
            </table>
        ...
        <div class="page-session">
            <table style="width: 100%;">
                ...
                <tr>
                    <td><span style="font-weight: bold; ">A. Variabel Survei</span></td>
                </tr>
                <tr>
            ...
            <table style="width: 100%;">
                <tr>
                    <td><span style="font-weight: bold; ">B. Kriteria Responden</span></td>
                </tr>
            ...
            <table style="width: 100%;">
                <tr>
                    <td><span style="font-weight: bold; ">C. Metode Pencacahan</span></td>
                </tr>
                <tr>
                    <td class="content-paragraph">
                ...
                <tr>
                    <td><span style="font-weight: bold; ">D. Metode Pengolahan Data dan Analisis</span></td>
                </tr>
                <tr>
                    <td class="content-paragraph">
        ...
        <table style="width: 100%;" class="">
            ...
            <table style="width: 100%;" class="">
                <tr>
                    <td style=" font-weight: bold; padding-left:1em;">2. Profil Responden</td>
                </tr>
                <tr>
                    <td style="padding-left:2em;">Berikut merupakan karakteristik responden yang diperoleh dari Survei Persepsi Anti Korupsi (SPAK):</td>
                </tr>
            </table>
            ...
            <?php
                ...
                foreach ($profil_responden->result() as $row) {
                     ...
                     ?>
                            ...
                            <li><b><?php echo $row->nama_profil_responden ?></b>
                                <br>
                                <br>
                                ...
                                <div style="text-align: center;">
                                    <div style="outline: dashed 1px black;">
                                        <img src="https://quickchart.io/chart?c={ type: 'horizontalBar', data: { labels: [
                                            <?php echo $kelompok_rekap_responden ?>], datasets: [{ label: 'Dataset 1', backgroundColor: 'rgb(255, 159, 64)', stack: 'Stack 0', data: [<?php echo $persentase_kelompok ?>], }, ], }, options: { title: { display: false, text: 'Chart.js Bar Chart - Stacked' }, legend: { display: false }, plugins: { roundedBars: true }, responsive: true, }, }" alt="" width="70%">
                                    </div>  
                                    <br>
                                    Gambar <?php echo $a++ ?>. Persentase Responden Berdasarkan <?php echo $row->nama_profil_responden ?>
                                    <br>
                                    <br>
                                </div>
                                ...
                                if($row->is_lainnya == 1) {
                                    ...
                                    <br>
                                    <br>
                                    <div style="text-align: center;">Tabel <?php echo $b++ ?>. Persentase Responden pada <?php echo $row->nama_profil_responden ?> Lainnya</div>

                                    <table style="width: 100%; margin-left: auto; margin-right: auto;" class="table-list">
                                        <tr style="background-color:#E4E6EF;">
                                            <th class="td-th-list">No</th>
                                            <th class="td-th-list"><?php echo $row->nama_profil_responden ?> Lainnya</th>
                                        </tr>
                                        ...
                                        ?>
                                        <tr>
                                            <td class="td-th-list"><?php echo $c++ ?></td>
                                            <td class="td-th-list" style="text-align:left;"><?php echo $value->$lainnya ?></td>
                                        </tr>
                                        <?php } } ?>
            ...
            <table style="width: 100%;" class="">
                ...
                <tr>
                    <td class="content-paragraph" style="padding-left: 2em;">Nilai unsur Survei Persepsi Anti Korupsi
                        (SPAK) pada <?php echo $manage_survey->organisasi ?> apabila diurutkan berdasarkan nilai tertinggi sampai terendah dapat dilihat pada
                        gambar di bawah ini.
                        <br>
                        <br>
                    </td>
        ...
        <div class="page-session">
            ...
            <table style="width: 100%; margin-left: auto; margin-right: auto; padding-left:2em;" class="table-list">
                ...
                <tr>
                    <td class="td-th-list">Responden <?= $e++ ?></td>
            ...
            <table style="width: 100%; padding-top:1em;">
                ...
                <tr>
                    <td style="padding-left:1em;">
                        ...
                        <br>
                        <br>
                        https://spak.surveiku.com/validasi-sertifikat/<?php echo $manage_survey->uuid ?>
                    </td>
                </tr>

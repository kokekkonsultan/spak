<?php
            ...
            ?>
                                ...
                                <tr>
                                    <td width="10%" style="padding-left: 8px;">
                                        <?php if ($user->foto_profile == NULL) : ?>
                                            <img src="<?php echo URL_AUTH ?>assets/klien/foto_profile/200px.jpg" height="60" alt="">
                                        <?php else : ?>
                                            <img src="<?php echo URL_AUTH ?>assets/klien/foto_profile/<?php echo $user->foto_profile ?>" height="60" alt="">
                                        <?php endif; ?>
                                    </td>
                                    <td class="text-right">
                ...
                <table style="padding:0; width: 95%; margin-left: auto; margin-right: auto;" class="table-list">
                    <tr>
                        <td class="th-td-draf" style="text-align:center; height:35px;">Dalam
                ...
                <table style="padding:0; width: 95%; margin-left: auto; margin-right: auto;" class="table-list">
                    <tr>
                        <td class="th-td-draf" style="text-align:left; background-color: black; color:white;">
                            <b>PENILAIAN TERHADAP UNSUR-UNSUR PERSEPSI ANTI KORUPSI</b>
                        </td>
                    </tr>

                    <tr>
                        <td class="th-td-draf" style="text-align:left; background-color: black; color:white;">
                            Berilah tanda silang (x) sesuai jawaban Saudara dan berikan alasan jika jawaban Saudara negatif(Tidak
                            atau Kurang Baik)
                        </td>
                    </tr>
                </table>

...
class OlahDataKeseluruhanController extends CI_Controller
{
    ...
    public function index()
    {
        ...
        // $this->data['induk'] = $this->db->get_where("pengguna_klien_induk", array('id_user' => $id_user))->row();

        $this->data['induk'] = $this->db->query("SELECT * FROM indeks_klien_induk WHERE id_user = $id_user");
    ...
    public function proses_index()
    {
            ...
            $this->db->insert('indeks_klien_induk', $object);
    ...
    public function history_nilai()
    {
        ...
        $id_user = $this->session->userdata('user_id');
        $this->data['nilai_induk']  = $this->db->query("SELECT * FROM indeks_klien_induk WHERE id_user = $id_user");

        $induk = $this->db->get_where("pengguna_klien_induk", array('id_user' => $this->session->userdata('user_id')))->row();
        $parent = unserialize($induk->cakupan_induk);
    ...
    public function edit()
	{
            ...
            $this->db->update('indeks_klien_induk', $object);
    ...
    public function delete()
	{
		...
		$this->db->delete('indeks_klien_induk');

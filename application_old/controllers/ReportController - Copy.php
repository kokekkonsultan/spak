...
class ReportController extends CI_Controller
{
    ...
    public function download_docx($username, $slug)
    {
        ...
        $section->addText('Survei Persepsi Anti Korupsi (SPAK)', array('name' => 'Arial', 'size' => 14, 'bold' => true), array('alignment' => \PhpOffice\PhpWord\SimpleType\Jc::CENTER, 'spaceAfter' => 100));
        $section->addTextBreak();
        ...
        $section->addText('BAB I', array('bold' => true, 'size' => 18), $paragraphStyleName);
        $section->addTextBreak();
        $section->addText('PENDAHULUAN', array('bold' => true, 'size' => 18), $paragraphStyleName);
        $section->addTextBreak();
        ...
        $texthtmlbab2 = '<ul><li><b>Variabel Survei</b><br>
        Variabel Survei Persepsi Anti Korupsi (SPAK) meliputi:
        <ul><li>Diskriminasi pelayanan</li>
        ...
        <li>Menerima imbalan dan/atau gratifikasi</li>
        ...
        <li><b>Metode Pengolahan Data dan Analisis</b><br>
        ...
        ';
        $section->addText('BAB II', array('bold' => true, 'size' => 18), $paragraphStyleName);
        $section->addTextBreak();
        $section->addText('METODOLOGI SURVEI', array('bold' => true, 'size' => 18), $paragraphStyleName);
        $section->addTextBreak();

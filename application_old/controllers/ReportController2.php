...
class ReportController extends CI_Controller
{
    ...
    if($bulan[ (int)$split1[1] ] == $bulan[ (int)$split2[1] ]){
        ...
        $subsequent->addText('Mahkamah Konstitusi', array('name' => 'Arial', 'size' => 11), array('alignment' => \PhpOffice\PhpWord\SimpleType\Jc::CENTER, 'spaceAfter' => 100));
        ...
        $section->addText('LAPORAN', array('bold' => true, 'size' => 22), array('alignment' => \PhpOffice\PhpWord\SimpleType\Jc::CENTER, 'spaceAfter' => 100));
        //$section->addTextBreak();
        $section->addText('SURVEI PERSEPSI ANTI KORUPSI (SPAK)', array('name' => 'Arial', 'size' => 22, 'bold' => true), array('alignment' => \PhpOffice\PhpWord\SimpleType\Jc::CENTER, 'spaceAfter' => 100));
        $section->addTextBreak();
        ...
        //$section->addTextBreak();
        $section->addText('MAHKAMAH KONSTITUSI', array('name' => 'Arial', 'size' => 14, 'bold' => true), array('alignment' => \PhpOffice\PhpWord\SimpleType\Jc::CENTER, 'spaceAfter' => 100));
        $section->addTextBreak();
        ...
        <li>Sebagai bahan dalam pengambilan kebijakan untuk peningkatan pelayanan di unit kerja;</li>
        <li>Menyediakan data dukung evaluasi Zona Integritas melalui mekanisme dan standar yang sama dengan kualitas hasil evaluasi yang dilakukan oleh Tim Penilai Nasional (TPN).</li>
        </ul>
        </li>
        </ul>';
        ...
        <tr>
            ...
            <p align="justify" style="text-indent: 50pt; ">Oleh karena pentingnya upaya pencegahan dan pemberantasan korupsi, maka setiap K/L/D diharuskan mengambil langkah-langkah yang diperlukan sesuai tugas, fungsi dan kewenangan masing-masing dalam rangka pencegahan dan pemberantasan korupsi di Indonesia. Langkah pencegahan dan pemberantasan korupsi oleh instansi pemerintah dapat diterapkan melalui Persepsi Anti Korupsi melalui Survei Persepsi Anti Korupsi (SPAK) yang akan menghasilkan nilai persepsi anti korupsi. Nilai Persepsi Anti Korupsi merupakan hasil survei kuantitatif terhadap stakeholders yang terkait dengan suatu instansi tentang tingkat korupsi yang terjadi pada instansi tersebut.</p>
        ...
        <tr>
            <td width="5%"></td>
            <td width="95%"><p align="justify" style="text-indent: 50pt; ">Responden adalah masyarakat yang telah mendapatkan pelayanan penanganan perkara di Mahkamah Konstitusi yaitu para pihak berperkara di Mahkamah Konstitusi. Hasil survei yang telah dilakukan, diperoleh responden sebanyak '.$jumlah_kuisioner.' responden.</p></td>
        </tr>
        <tr>
            <td width="5%">&nbsp;</td>
            <td width="95%">&nbsp;</td>
        ...
        Hasil Survei Persepsi Anti Korupsi (SPAK) '.$data_survei['nama_organisasi'].' mendapatkan nilai Indeks Persepsi Anti Korupsi sebesar ' . ROUND($nilai_skm, 2) . ', dengan predikat ' . $index . '. Nilai Indeks Persepsi Anti Korupsi tersebut didapat dari nilai rata-rata seluruh unsur pada tabel berikut.';
        $texthtmlbab32 = '<table>
        <tr>
            <td width="5%"><b>2.</b></td>
        ...
        <tr>
            <td width="5%"></td>
            <td width="95%"><p align="justify" style="text-indent: 50pt; ">Hasil Survei Persepsi Anti Korupsi (SPAK) '.$data_survei['nama_organisasi'].' mendapatkan nilai Indeks Persepsi Anti Korupsi sebesar <b>' . ROUND($nilai_skm, 2) . '</b>, dengan predikat <b>' . $index . '</b>. Nilai Indeks Persepsi Anti Korupsi tersebut didapat dari nilai rata-rata seluruh unsur pada tabel berikut.</p></td>
        </tr>
        </table>';
        ...
        $section->addText('Tabel 1. Nilai IPAK', array('size' => 11), $paragraphStyleName);
        ...
        */
        ...
        foreach ($list_responden->result() as $value) {
            ...
            foreach ($profil_responden_bab4 as $get) {
                ...
                $table->addCell(2000)->addText($value->$profil, $cellTableFontStyle);
            }
        }

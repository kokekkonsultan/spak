                    ...
                    <ul class="nav nav-tabs" id="myTab" role="tablist">
                        <li class="nav-item">
                            <a class="nav-link active" id="home-tab" data-toggle="tab" href="#home" role="tab"
                                aria-controls="home" aria-selected="true">LOGO FORM SURVEI</a>
                        </li>
                        <li class="nav-item">
                            <a class="nav-link" id="benner-tab" data-toggle="tab" href="#benner" role="tab"
                                aria-controls="benner" aria-selected="false">BENNER FORM SURVEI</a>
                        </li>
                                ...
                                <div class="card card-body shadow mb-5">
                                    <form id="uploadForm">
                                        ...
                                        <div class="text-right mt-3">
                                            ...
                                            <button type="submit"
                                                class="btn btn-primary btn-sm font-weight-bold tombolUploud">Uploud</button>
                                        </div>
                                    </form>
                                </div>
                            </div>

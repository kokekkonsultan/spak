        ...
        <div class="col-md-9">
            ...
            <!-- <div class="card card-custom card-sticky mb-5" data-aos="fade-down">
                <div class="card-body">
                    ...
                    <form action="{{base_url() . $ci->session->userdata('username') . '/' . $ci->uri->segment(2) . '/layanan-survei/pilihan-jenis'}}" method="POST" class="form_default">
                            ...
                            <div class="col-11 col-form-label">
                                <div class="radio-inline">
                                    <label class="radio radio">
                                        <input type="radio" name="is_layanan_survei" value="1" {{$profiles->is_layanan_survei == 1 ? 'checked' : ''}} required>
                                        <span></span>
                                        1 Jenis Layanan
                                    </label>
                                </div>
                                ...
                                <div class="radio-inline">
                                    <label class="radio radio">
                                        <input type="radio" name="is_layanan_survei" value="2" {{$profiles->is_layanan_survei == 2 ? 'checked' : ''}}>
                                        <span></span>

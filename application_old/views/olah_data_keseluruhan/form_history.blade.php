                        ...
                        <tbody>
                            ...
                            <tr>
                                ...
                                <td>
                                    ...
                                    @foreach($ci->db->query("SELECT * FROM manage_survey WHERE id IN ($id_object)")->result() as $value)
                                    ...
                                    if ($ci->db->get_where("survey_$value->table_identity", array('is_submit' => 1))->num_rows() > 0) {
                                        ...
                                        $nilai_per_unsur = $ci->db->query("SELECT IF(id_parent = 0,unsur_pelayanan_$value->table_identity.id, unsur_pelayanan_$value->table_identity.id_parent) AS id_sub,
                                    ...
                                    <li>{{$value->survey_name}} <b>({{$value->organisasi}})</b> - <b class="text-primary">{{ROUND($nilai,3)}}</b></li>
                                ...
                                <a class="btn btn-light-primary btn-sm" data-toggle="modal" data-target="#edit_{{$row->id}}">
                                ...
                                <a class="btn btn-light-primary btn-sm font-weight-bold shadow" href="javascript:void(0)" title="Hapus {{$row->label}}" onclick="delete_data({{$row->id}})"><i class="fa fa-trash"></i> Delete</a>
                                    ...
                                    <div class="modal-dialog" role="document">
                                        ...
                                        <div class="modal-content border border-secondary">
                                            ...
                                            <div class="modal-body">
                                                ...
                                                <form class="form_default" action="<?php echo base_url() . 'olah-data-keseluruhan/edit' ?>" method="POST">
                                                    ...
                                                    <div class="form-group">
                                                        ...
                                                        <div class="checkbox-list mb-3">
                                                            ...
                                                            <label class="checkbox"><input type="checkbox" name="id[]" value="{{$get->id}}" <?php echo in_array($get->id, $parent_obj) ? 'checked' : '' ?>><span></span> {{$get->survey_name}}</label>
...
function delete_data(id) {
    ...
    if (confirm('Are you sure delete this data?')) {
        ...
        $.ajax({
            ...
            url: "<?php echo base_url() . 'history-nilai-per-periode/delete/' ?>" +

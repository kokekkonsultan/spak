                                ...
                                <div class="d-flex flex-wrap align-items-center py-2">
                                    <div class="d-flex align-items-center">
                                        ...
                                        <div class="">
                                            ...
                                            <span
                                                class="btn btn-sm btn-text btn-light-primary text-uppercase font-weight-bold">
                                                {{$profiles->skala_likert == '' ? 4 : $profiles->skala_likert}} Pilihan
                                                Jawaban</span>
                                        </div>
                                    </div>
                                </div>
                    ...
                    <form
                        ...
                        <div class="mb-5">
                            ...
                            <textarea class="form-control" name="deskripsi" value=""
                                required><?php echo $manage_survey->description ?></textarea>
                        </div>
                        ...
                        <div class="row mb-5">
                            <div class="col-sm-6">
                                ...
                                <input type="text" class="form-control" name="alamat"
                                    value="<?php echo $manage_survey->alamat ?>" required>
                            </div>
                            ...
                            <div class="col-sm-4">
                                ...
                                <input type="email" class="form-control" name="email"
                                    value="<?php echo $manage_survey->email ?>" required>
                            </div>
                            ...
                            <div class="col-sm-2">
                                ...
                                <input type="number" class="form-control" name="nomor"
                                    value="<?php echo $manage_survey->no_tlpn ?>" required>
                            </div>
                        </div>
...
<script type="text/javascript">
    // || $manage_survey->misi == '' || $manage_survey->visi == ''
